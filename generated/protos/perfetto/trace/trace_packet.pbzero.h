...
class TracePacket_Decoder : public ::protozero::TypedProtoDecoder</*MAX_FIELD_ID=*/900, /*HAS_NONPACKED_REPEATED_FIELDS=*/false> {
 public:
  ...
  bool has_ostats_data() const { return at<300>().valid(); }
  ::protozero::ConstBytes ostats_data() const { return at<300>().as_bytes(); }
...
class TracePacket : public ::protozero::Message {
 public:
  ...
  using FieldMetadata_OstatsData =
    ::protozero::proto_utils::FieldMetadata<
      300,
      ::protozero::proto_utils::RepetitionType::kNotRepeated,
      ::protozero::proto_utils::ProtoSchemaType::kMessage,
  ...
  static constexpr FieldMetadata_OstatsData kOstatsData{};
  template <typename T = OStatsData> T* set_ostats_data() {
