...
class SchedBlockedReasonFtraceEvent_Decoder : public ::protozero::TypedProtoDecoder</*MAX_FIELD_ID=*/7, /*HAS_NONPACKED_REPEATED_FIELDS=*/false> {
 public:
  ...
  bool has_layer1() const { return at<4>().valid(); }
  uint64_t layer1() const { return at<4>().as_uint64(); }
  bool has_layer2() const { return at<5>().valid(); }
  uint64_t layer2() const { return at<5>().as_uint64(); }
  bool has_layer3() const { return at<6>().valid(); }
  uint64_t layer3() const { return at<6>().as_uint64(); }
  bool has_layer4() const { return at<7>().valid(); }
  uint64_t layer4() const { return at<7>().as_uint64(); }
};
...
class SchedBlockedReasonFtraceEvent : public ::protozero::Message {
 public:
  ...
  enum : int32_t {
    ...
    kLayer1FieldNumber = 4,
    kLayer2FieldNumber = 5,
    kLayer3FieldNumber = 6,
    kLayer4FieldNumber = 7,
  };
  ...
  static constexpr FieldMetadata_Layer1 kLayer1{};
  void set_layer1(uint64_t value) {
    static constexpr uint32_t field_id = FieldMetadata_Layer1::kFieldId;
    // Call the appropriate protozero::Message::Append(field_id, ...)
    // method based on the type of the field.
    ::protozero::internal::FieldWriter<
      ::protozero::proto_utils::ProtoSchemaType::kUint64>
  ...
  static constexpr FieldMetadata_Layer2 kLayer2{};
  void set_layer2(uint64_t value) {
    static constexpr uint32_t field_id = FieldMetadata_Layer2::kFieldId;
    // Call the appropriate protozero::Message::Append(field_id, ...)
    // method based on the type of the field.
    ::protozero::internal::FieldWriter<
      ::protozero::proto_utils::ProtoSchemaType::kUint64>
  ...
  static constexpr FieldMetadata_Layer3 kLayer3{};
  void set_layer3(uint64_t value) {
    static constexpr uint32_t field_id = FieldMetadata_Layer3::kFieldId;
    // Call the appropriate protozero::Message::Append(field_id, ...)
    // method based on the type of the field.
    ::protozero::internal::FieldWriter<
      ::protozero::proto_utils::ProtoSchemaType::kUint64>
  ...
  static constexpr FieldMetadata_Layer4 kLayer4{};
  void set_layer4(uint64_t value) {
    static constexpr uint32_t field_id = FieldMetadata_Layer4::kFieldId;
    // Call the appropriate protozero::Message::Append(field_id, ...)
    // method based on the type of the field.
    ::protozero::internal::FieldWriter<
      ::protozero::proto_utils::ProtoSchemaType::kUint64>
