...
class F2fsDataReadStartFtraceEvent;
...
class FilemapMapPagesFtraceEvent;
...
class FtraceEvent_Decoder : public ::protozero::TypedProtoDecoder</*MAX_FIELD_ID=*/667, /*HAS_NONPACKED_REPEATED_FIELDS=*/false> {
 public:
  ...
  bool has_f2fs_dataread_start() const { return at<666>().valid(); }
  ::protozero::ConstBytes f2fs_dataread_start() const { return at<666>().as_bytes(); }
  bool has_filemap_map_pages() const { return at<667>().valid(); }
  ::protozero::ConstBytes filemap_map_pages() const { return at<667>().as_bytes(); }
...
class FtraceEvent : public ::protozero::Message {
 public:
  ...
  enum : int32_t {
    ...
    kF2fsDatareadStartFieldNumber = 666,
    kFilemapMapPagesFieldNumber = 667,
  ...
  using FieldMetadata_F2fsDatareadStart =
    ::protozero::proto_utils::FieldMetadata<
      666,
      ::protozero::proto_utils::RepetitionType::kNotRepeated,
      ::protozero::proto_utils::ProtoSchemaType::kMessage,
  ...
  static constexpr FieldMetadata_F2fsDatareadStart kF2fsDatareadStart{};
  template <typename T = F2fsDataReadStartFtraceEvent> T* set_f2fs_dataread_start() {
    return BeginNestedMessage<T>(666);
  }


  using FieldMetadata_FilemapMapPages =
    ::protozero::proto_utils::FieldMetadata<
      667,
      ::protozero::proto_utils::RepetitionType::kNotRepeated,
      ::protozero::proto_utils::ProtoSchemaType::kMessage,
  ...
  static constexpr FieldMetadata_FilemapMapPages kFilemapMapPages{};
  template <typename T = FilemapMapPagesFtraceEvent> T* set_filemap_map_pages() {
    return BeginNestedMessage<T>(667);
  }
