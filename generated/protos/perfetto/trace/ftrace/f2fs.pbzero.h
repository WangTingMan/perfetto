...
class F2fsDataReadStartFtraceEvent_Decoder : public ::protozero::TypedProtoDecoder</*MAX_FIELD_ID=*/9, /*HAS_NONPACKED_REPEATED_FIELDS=*/false> {
 public:
  F2fsDataReadStartFtraceEvent_Decoder(const uint8_t* data, size_t len) : TypedProtoDecoder(data, len) {}
  explicit F2fsDataReadStartFtraceEvent_Decoder(const std::string& raw) : TypedProtoDecoder(reinterpret_cast<const uint8_t*>(raw.data()), raw.size()) {}
  explicit F2fsDataReadStartFtraceEvent_Decoder(const ::protozero::ConstBytes& raw) : TypedProtoDecoder(raw.data, raw.size) {}
  bool has_pathbuf() const { return at<1>().valid(); }
  ::protozero::ConstChars pathbuf() const { return at<1>().as_string(); }
  bool has_offset() const { return at<2>().valid(); }
  uint64_t offset() const { return at<2>().as_uint64(); }
  bool has_bytes() const { return at<3>().valid(); }
  int32_t bytes() const { return at<3>().as_int32(); }
  bool has_cmdline() const { return at<4>().valid(); }
  ::protozero::ConstChars cmdline() const { return at<4>().as_string(); }
  bool has_pid() const { return at<5>().valid(); }
  uint64_t pid() const { return at<5>().as_uint64(); }
  bool has_i_size() const { return at<6>().valid(); }
  uint64_t i_size() const { return at<6>().as_uint64(); }
  bool has_ino() const { return at<7>().valid(); }
  uint64_t ino() const { return at<7>().as_uint64(); }
  bool has_mtime() const { return at<8>().valid(); }
  uint64_t mtime() const { return at<8>().as_uint64(); }
  bool has_i_generation() const { return at<9>().valid(); }
  uint32_t i_generation() const { return at<9>().as_uint32(); }
};

class F2fsDataReadStartFtraceEvent : public ::protozero::Message {
 public:
  using Decoder = F2fsDataReadStartFtraceEvent_Decoder;
  enum : int32_t {
    kPathbufFieldNumber = 1,
    ...
    kInoFieldNumber = 7,
    kMtimeFieldNumber = 8,
    kIGenerationFieldNumber = 9,
  };
  static constexpr const char* GetName() { return ".perfetto.protos.F2fsDataReadStartFtraceEvent"; }
  ...
  void set_i_size(uint64_t value) {
  ...
  static constexpr FieldMetadata_Mtime kMtime{};
  void set_mtime(uint64_t value) {
    static constexpr uint32_t field_id = FieldMetadata_Mtime::kFieldId;
    // Call the appropriate protozero::Message::Append(field_id, ...)
    // method based on the type of the field.
    ::protozero::internal::FieldWriter<
      ::protozero::proto_utils::ProtoSchemaType::kUint64>
  ...
  using FieldMetadata_IGeneration =
    ::protozero::proto_utils::FieldMetadata<
      9,
      ::protozero::proto_utils::RepetitionType::kNotRepeated,
      ::protozero::proto_utils::ProtoSchemaType::kUint32,
  ...
  static constexpr FieldMetadata_IGeneration kIGeneration{};
  void set_i_generation(uint32_t value) {
    static constexpr uint32_t field_id = FieldMetadata_IGeneration::kFieldId;
    // Call the appropriate protozero::Message::Append(field_id, ...)
    // method based on the type of the field.
    ::protozero::internal::FieldWriter<
      ::protozero::proto_utils::ProtoSchemaType::kUint32>
